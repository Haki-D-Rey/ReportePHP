...
require('./code128.php'); // Asegúrate de tener el archivo code128.php en tu proyecto
...
class FacturaPDF extends PDF_Code128  {
...
$factura->setCliente("Carlos Alfaro", "00000000", "DNI", "00000000", "San Salvador, El Salvador, Centro América");
